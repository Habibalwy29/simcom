...
<div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="flex w-full max-w-4xl bg-white rounded-xl shadow-2xl overflow-hidden my-8">
        ...
        <div class="w-1/2 bg-green-600 flex-col items-center justify-center p-12 text-white hidden md:flex">
            <img src="{{ asset('images/logo sim.png') }}" alt="SIM.com Logo" class="h-28 w-auto mb-6" onerror="this.onerror=null;this.src='https://placehold.co/150x50/FFFFFF/4DB6AC?text=SIM';this.style.height='50px';" />
