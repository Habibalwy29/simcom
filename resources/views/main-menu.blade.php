    ...
    <div class="bg-white p-8 rounded-xl shadow-2xl text-center max-w-2xl w-full transform transition-all duration-500 hover:scale-105 border border-teal-200">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <a href="{{ route('calorieCalculator') }}"
                class="flex flex-col items-center justify-center p-8 bg-teal-600 hover:bg-teal-700 text-white rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-teal-300">
